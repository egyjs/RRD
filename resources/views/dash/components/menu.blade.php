    ...
    <ul class="list">
        ...
        <li><a href="javascript:void(0);" class="menu-toggle"><i class="material-icons">visibility</i><span>View</span></a>
            <ul class="ml-menu">
                ...
                <li><a href="{{route('dash.view.posts')}}"><i class="material-icons">note</i><span class="fix-nav">View Posts</span></a></li>
                @endif
            </ul>
        </li>
        @endif
        ...
        <li><a href="javascript:void(0);" class="menu-toggle"><i class="material-icons">add</i><span>Add</span></a>
            <ul class="ml-menu">
                @if(hasRole('manager') or hasRole('Writer'))
                    <li><a href="{{route('dash.add.post')}}"><i class="material-icons">note</i><span class="fix-nav">Add Post</span></a></li>
