                        ...
                        <div class="row clearfix">
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <input autofocus type="text" class="form-control" name="PostTitle" placeholder="title" id="PostTitle">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <input type="text" name="Postdesc" class="form-control" placeholder="page. Description" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote" class="form-control my-editor" name="Postcont"></textarea>
                                </div>
                            </div>
