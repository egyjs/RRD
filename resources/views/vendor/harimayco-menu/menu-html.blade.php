						...
						<div class="wrap">
							...
							<div class="manage-menus">
								<form method="get" action="{{ $currentUrl }}">
									...
									<span class="add-new-menu-action"> or <a class="btn btn-primary" href="{{ $currentUrl }}?action=edit&menu=0">Create new menu</a>. </span>
								</form>
							</div>
														...
														<div class="inside">
															<div class="customlinkdiv" id="customlinkdiv">
																...
																<p class="button-controls">
																	...
																	<a  href="#" onclick="addcustommenu()"  class="btn btn-primary right"  >Add menu item</a>
															...
															<li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
																...
																<div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
																	...
																	<div class="menu-item-actions description-wide submitbox">
																		...
																		<a class="item-cancel submitcancel hide-if-no-js btn btn-primary" id="cancel-{{$m->id}}" href="{{ $currentUrl }}?edit-menu-item={{$m->id}}&cancel=1424297719#menu-item-settings-{{$m->id}}">Cancel</a>
																		<span class="meta-sep hide-if-no-js"> | </span>
