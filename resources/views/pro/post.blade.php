        ...
        <div class="main_blog_details">
            ...
            <div class="card" style="max-width: 100%">
                ...
                <div class="row">
                        ...
                        {{--</div>--}}
                        <div class="arrow">
                            <a href="{{ route('project.post',$perv->slug) }}"><span class="lnr text-white lnr-arrow-left"></span></a>
                        </div>
                        <div class="detials">
                            <p>Prev Post</p>
                            <a href="{{ route('project.post',$perv->slug) }}">
                                <h4>{{ $perv->title }}</h4>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="detials">
                            <p>Next Post</p>
                            <a href="{{ route('project.post',$next->slug) }}">
                                <h4>{{ $next->title }}</h4>
                            </a>
                        </div>
                        <div class="arrow">
                            <a href="{{ route('project.post',$next->slug) }}"><span class="lnr text-white lnr-arrow-right"></span></a>
                        </div>
                    </div>
                        @endif
                </div>
        ...
        @push('js')
            <script>
                ...
                var disqus_config = function () {
                    ...
                    this.page.identifier = "pro-{{ $pro->slug }}"; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
                };
