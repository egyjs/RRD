    ...
    <div class="page bg-light pb-4" id="singlepost">
        <div class="header">
            ...
            <div class="container info">
                <h1 class="title box">{{ $post->title }}</h1>
                <h5 class="box"><i class="icofont icofont-man-in-glasses"></i> {{ $post->writer->fullname }}</h5>
            </div>
        </div>
        <div class="container mt-2 mb-2">
            <div class="card pt-4">
                <div class="card-body content">
                    <h1 class="title"><i style="color: #ff8431" class="icofont icofont-heading"></i> {{ $post->title }}</h1>
                    <p>
                        {!! $post->content !!}
                    </p>
                </div>
